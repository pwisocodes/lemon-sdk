...
def test_search_instrument(account, mocker, search_instrument_result):
    ...
    mocker.patch('lemon.core.market.ApiRequest._perform_request', mock_perform_request)
    m = MarketData()
...
def test_ohlc(account, mocker, ohlc_result):
    ...
    ohlc = m.ohlc(
        ...
        start=datetime.fromisoformat('2022-04-05'),
        end=datetime.fromisoformat('2022-04-05'),
        isin='IE00B3RBWM25',
        venue=VENUE.GETTEX,
    )
